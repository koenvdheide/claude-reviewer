...
Write-Host "  - /qa skill"
Write-Host ""
Write-Host "Automatic reviewing now uses project-level hooks, not a CLAUDE.md snippet."
...
Write-Host "Curate reviewer memory periodically to consolidate patterns and remove false positives!"
